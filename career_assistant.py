...
resume_parser = Agent(
    ...
    #storage=SqlAgentStorage(table_name="resume_parser", db_file="agents.db"),
...
job_recommender = Agent(
    ...
    #storage=SqlAgentStorage(table_name="job_recommender", db_file="agents.db"),
    show_tool_calls=True,
    markdown=True,
)
...
career_coach = Agent(
    ...
    #storage=SqlAgentStorage(table_name="career_coach", db_file="agents.db"),
    show_tool_calls=True,
    markdown=True,
)
